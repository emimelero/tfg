...
![Vista de la app](public/images/imagenes_demo/hacer-socio.JPG)
#### Pagina de reservas
![Vista de la app](public/images/imagenes_demo/reserva.JPG)

#### Pagina de ver el perfil con los datos del socio
![Vista de la app](public/images/imagenes_demo/mi-perfil-socio.JPG)
#### Pagina de edicion del socio 
![Vista de la app](public/images/imagenes_demo/edit-socio.JPG)
#### Pagina del listado personal de reservas de cada socio
![Vista de la app](public/images/imagenes_demo/mi-listado-reservas.JPG)
#### Pagina principal en modo de administrador (usuario: admin, contraseña: admin)
![Vista de la app](public/images/imagenes_demo/main-page-admin.JPG)
#### Pagina agregar pista
![Vista de la app](public/images/imagenes_demo/add-pista.JPG)
#### Pagina de registro de todos los usuarios que SI son socios
![Vista de la app](public/images/imagenes_demo/todos-socios.JPG)
#### Pagina de reservas generales. Registradas todas las reservas de todos los usuarios
![Vista de la app](public/images/imagenes_demo/todas-reservas.JPG)